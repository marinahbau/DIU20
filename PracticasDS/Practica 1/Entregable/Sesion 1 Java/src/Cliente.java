...
public class Cliente {
    ...
    public static void main(String[] args){
        ...
        //lanzamos las carreras con un tiempo en segundos de retirada de un % de las bicicletas
